...
const PrivacyContent = buildLocalizedLegalContent({
  en: () => import("../../ui/legal/privacy-content.en").then((module) => ({ default: module.PrivacyEN })),
  fr: () => import("../../ui/legal/privacy-content.fr").then((module) => ({ default: module.PrivacyFR })),
  es: () => import("../../ui/legal/privacy-content.es").then((module) => ({ default: module.PrivacyES }))
});

export default function PrivacyPolicy({ baseUrl }: PageProps) {
  ...
  return (
    <>
      <Head>
        <title>{tSeo("legalPrivacy.title")}</title>
        <meta name="description" content={normalizeMetaDescription(tSeo("legalPrivacy.description"))} />
        <meta name="robots" content={robotsContent} />
        <link rel="canonical" href={canonicalUrl} />
        {hrefLangs.map((tag) => (
          <link key={tag.hrefLang} rel="alternate" hrefLang={tag.hrefLang} href={tag.href} />
        ))}
        <meta property="og:title" content={tSeo("legalPrivacy.ogTitle")} />
        <meta property="og:description" content={tSeo("legalPrivacy.ogDescription")} />
      ...
      <LegalPageLayout title={title} lastUpdated={LAST_UPDATED}>
        <PrivacyContent locale={resolvedLocale} />
      </LegalPageLayout>
    </>
  );
}
