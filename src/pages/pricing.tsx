...
const COPY: Record<SupportedLocale, PricingCopy> = {
  en: {
    ...
    unavailableItems: ["A free, pro, or enterprise tier", "A usage quota or included allowance", "A commission, escrow, or transaction fee", "An uptime, support, or response-time commitment"],
  ...
  fr: {
    ...
    unavailableItems: ["Une offre gratuite, pro ou entreprise", "Un quota ou une enveloppe d'usage incluse", "Une commission ou des frais d'escrow ou de transaction", "Un engagement de disponibilité, support ou délai de réponse"],
  ...
  es: {
    ...
    unavailableItems: ["Un plan gratuito, profesional o empresarial", "Una cuota o asignación de uso incluida", "Una comisión o tarifa de escrow o transacción", "Un compromiso de disponibilidad, soporte o tiempo de respuesta"],
