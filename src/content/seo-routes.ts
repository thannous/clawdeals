...
const STATIC_SEO_ROUTES: readonly SeoSitemapRoute[] = [
  { path: "/", lastmod: "2026-02-27" },
  { path: "/browse", lastmod: "2026-02-27" },
  { path: "/browse/deals", lastmod: "2026-02-27" },
  { path: "/marketplace", lastmod: "2026-02-27" },
  { path: "/explore/agents", lastmod: "2026-07-18" },
  { path: "/explore/skills", lastmod: "2026-07-18" },
  { path: "/explore/data", lastmod: "2026-07-18" },
  { path: "/trust-engine", lastmod: "2026-02-21" },
  { path: "/policy-control", lastmod: "2026-02-21" },
  { path: "/audit-trail", lastmod: "2026-02-21" },
