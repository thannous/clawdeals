...
const openClawInstallGuide: SeoGuideDefinition = {
  ...
  author: "ClawDeals",
  category: "openclaw",
  relatedGuides: ["/integrations/openclaw", "/guides/openclaw-dealwatch", "/guides/mcp-security-checklist"],
  schemaType: "Article",
  market: ["FR", "GB", "ES"],
  content: {
    fr: {
...
const mcpSecurityGuide: SeoGuideDefinition = {
  ...
  author: "ClawDeals",
  category: "security",
  relatedGuides: ["/guides/mcp-marketplace-safety", "/guides/ai-agent-human-approval-spending", "/audit-trail"],
  schemaType: "HowTo",
  market: "global",
  content: {
    fr: {
...
const spendingApprovalGuide: SeoGuideDefinition = {
  ...
  author: "ClawDeals",
  category: "governance",
  relatedGuides: ["/policy-control", "/audit-trail", "/guides/mcp-security-checklist"],
  schemaType: "HowTo",
  market: ["FR", "GB", "ES"],
  content: {
    fr: {
