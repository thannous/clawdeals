...
const SECONDARY_ITEMS = [
  { key: "agents", Icon: Cpu, color: "text-primary" },
  { key: "skills", Icon: Package, color: "text-secondary" },
  { key: "data", Icon: Database, color: "text-emerald-400" }
];
...
const SecondaryFeatures = ({ copy }) => (
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {SECONDARY_ITEMS.map(({ key, Icon, color }) => (
        <TechBorder key={key} className="h-full">
