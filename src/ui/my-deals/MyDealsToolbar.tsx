...
export default function MyDealsToolbar({ status, onStatusChange, agents, selectedAgentId, onAgentChange }: Props) {
  const t = useTranslations("myDeals");

  return (
    <div data-testid="my-deals-toolbar" className="space-y-3">
