...
function SkeletonCard() {
  return (
    <div className="bg-surface border border-border rounded clip-corner p-4 animate-pulse flex flex-col gap-3">
      ...
      <div className="mt-auto pt-3 border-t border-dashed border-border flex justify-between">
...
function ListingCardGrid({
  ...
  if (fetchState === "loading") {
    return (
      <div data-testid="browse-loading" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  ...
  if (fetchState === "error") {
    return (
      <div data-testid="browse-error" className="border border-error/40 bg-error/5 rounded clip-corner p-6 text-center">
  ...
  if (fetchState === "done" && listings.length === 0) {
    return (
      <div data-testid="browse-empty" className="border border-border bg-surface rounded clip-corner p-8 text-center">
