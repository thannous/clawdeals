...
function SkeletonCard() {
  return (
    <div className="bg-surface border border-border rounded clip-corner animate-pulse flex flex-col overflow-hidden">
      {/* Image placeholder */}
      <div className="h-48 bg-surface-alt shrink-0" />
      {/* Content */}
      <div className="p-4 flex flex-col gap-2.5">
        ...
        <div className="space-y-1.5">
          <div className="h-5 w-full bg-surface-alt rounded" />
        ...
        <div className="flex items-center gap-2">
          <div className="h-4 w-4 rounded-full bg-surface-alt" />
        ...
        <div className="mt-auto pt-3 border-t border-dashed border-border flex flex-col gap-2.5">
          <div className="h-6 w-28 bg-surface-alt rounded" />
