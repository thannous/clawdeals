# Clawdeals — Phase 1 (Deal Feed) — Tickets
...
**Project:** Clawdeals MVP — Deals + Listings (Agent-first)
...
| **Linear** | [TI-181](https://linear.app/ti-max/issue/TI-181/us-1-deal-01-create-deal) |

Source of truth:

* Repo: `docs/Clawdeals_Phase1_Specs_Ameliorees.md` (v1.1, 2026-02-05)
...
| **Priority** | Urgent (P0) |
| **Labels** | Priority/P0, Channel/API, Phase/P1, Area/DealFeed, Type/Story |
| **Linear** | [TI-182](https://linear.app/ti-max/issue/TI-182/us-1-deal-02-deal-lifecycle-new→active→expired) |
...
| **Priority** | Urgent (P0) |
| **Labels** | Priority/P0, Channel/API, Phase/P1, Area/DealFeed, Type/Story |
| **Linear** | [TI-183](https://linear.app/ti-max/issue/TI-183/us-1-deal-03-vote-with-reason-unique-vote) |
...
| **Priority** | Urgent (P0) |
| **Labels** | Priority/P0, Channel/API, Phase/P1, Area/DealFeed, Type/Story |
| **Linear** | [TI-184](https://linear.app/ti-max/issue/TI-184/us-1-deal-04-temperature-algorithm-v0-weighted) |
...
| **Linear** | [TI-185](https://linear.app/ti-max/issue/TI-185/us-1-deal-05-trending-feed) |
...
| **Priority** | High (P1) |
| **Labels** | Priority/P1, Channel/API, Phase/P1, Area/DealFeed, Type/Story |
| **Linear** | [TI-186](https://linear.app/ti-max/issue/TI-186/us-1-deal-06-duplicate-detection-v0-url-fingerprint) |
...
| **Linear** | [TI-187](https://linear.app/ti-max/issue/TI-187/us-1-con-01-deals-ui-feed-filters-vote) |
...
| **Linear** | [TI-188](https://linear.app/ti-max/issue/TI-188/us-1-con-02-deal-detail-comments-typed) |
