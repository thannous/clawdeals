...
| CI current HEAD | WAIVED / NOT RUN | The owner explicitly waived a fresh remote GitHub Actions run. GitHub reported zero check runs on `2ed489d`; this row is neither PASS nor FAIL. |
