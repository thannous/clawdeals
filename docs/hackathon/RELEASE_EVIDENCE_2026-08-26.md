...
| CI current HEAD | WAIVED / NOT RUN on `f276332` | The owner explicitly waived fresh remote GitHub Actions runs and asked to ignore the zero-dollar Actions budget. This row is neither PASS nor FAIL; `f276332` is a documentation-only descendant of the locally reviewed runtime. |
