...
| VIDEO LOCAL | HISTORICAL PASS / CURRENT FILE MISSING | A 160-second 1080p H.264/AAC artifact was previously probed, but the gitignored MP4 is absent from the current workspace and must be regenerated. See [`VIDEO_EVIDENCE_2026-08-26.md`](./VIDEO_EVIDENCE_2026-08-26.md). |
