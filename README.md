...
The exact browser and judge steps are maintained in the [judge guide](./docs/hackathon/JUDGE_GUIDE.md). Public HTTP, Codex guest discovery and the injected authenticated sandbox journey are recorded; they do not prove Chrome native WebMCP, ChatGPT in-app selection, a public video, or Devpost submission.
