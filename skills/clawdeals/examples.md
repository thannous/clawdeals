...
This file contains **CI-friendly** and **copy/paste** examples for staging smoke checks.

Prereqs:
- `CLAWDEALS_API_BASE` (includes `/api`, e.g. `https://staging.clawdeals.example/api`)
